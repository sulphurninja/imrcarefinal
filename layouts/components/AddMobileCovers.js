...
const AddMobileCovers = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setIsSubmitted(true);
            setIsUploading(false);
            await axios.post('/api/addMobileCovers', {
                name: categoryName,
                image: accImage,
                description,
                price,
            ...
            {isOpen && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    <div className="bg-[#5E474C] text-white rounded-lg shadow-lg p-6">
                        <h2 className="text-xl font-bold font-coffee mb-4">Add Mobile Cover</h2>
...
export default AddMobileCovers;
